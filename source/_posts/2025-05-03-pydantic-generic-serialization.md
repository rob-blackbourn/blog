...
We switched to [Pydantic](https://github.com/pydantic/pydantic),
...
You can find the code for this blog [here](https://github.com/rob-blackbourn/demo-pydantic-generic-serialization).